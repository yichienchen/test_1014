...
public class Constants {
    ...
    public  static final int NAME=R.string.student_name;
    public  static final int NUMBER=R.string.phone_number;
    public static final int SERVER_MSG_FIRST_STATE = 107064537;
    public static final int SERVER_MSG_SECOND_STATE = 9568838;
